                ...
                <div className="row">
                    <div className='flex flex-col px-[20px] sm:px-[25px] py-[60px] sm:flex-row sm:justify-center items-center'>
                        ...
                        {props.products.map((item) => (               
                                ...
                                <div key={item._id} className="p-[10px] m-4 w-[75%] sm:w-[45%] md:w-[38%] lg:w-[30%] xl:w-[24%] bg-[#fff] shadow-2xl rounded-md hover:p-2 hover:border-2 hover:border-[#3b82f6]">
                                    <Link to={`/products/${item._id}`} className='hover:text-[#227418]'>
                                        ...
                                        <div className="text-center py-6">
                                            ...
                                            <p className="">
                                                {item.productDescription.length > 30 ? item.productDescription.slice(0,30) + '...' : item.productDescription.slice(0,30) }
                                            </p>
